...
('a1095504', '工藝與創意設計學系', '謝欣儀', '111', 'a1095504@mail.nuk.edu.tw', '0904004004', '女', 2, 2),
('a1095557', '亞太工商管理學系', '陳柏安', '112', 'a109557@mail.nuk.edu.tw', '0912345678', '男', NULL, NULL);
...
--
ALTER TABLE `application`
  MODIFY `A_Number` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
